...
export const catalogCategories: CatalogCategoryDef[] = [
  {
    ...
    coverFallback: "/images/products/romano/proyectos/casa-retiro-matizado/Casa_ladrilloromano_Clayhouse (22).jpg",
  },
  {
    id: "Divisorios",
    label: "Divisorios",
  ...
  },
  {
    ...
    label: "Enchapes",
    title: "Enchapes",
    description: "Revestimientos delgados de barro para muros interiores, exteriores y detalles de acento.",
    order: 4,
  ...
  },
  {
    ...
    label: "Techos",
    title: "Techos",
    description: "Teja Plana y Teja Colonial para cubiertas visibles en barro cocido.",
    order: 5,
