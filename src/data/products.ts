...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Enchapes",
    shortDescription:
      "Revestimiento delgado tipo thin brick (20 × 5 cm, espesor 1 cm) para muros interiores, en cuatro tonos: Natural, Bianco, Capuccino y Cocoa.",
    description:
      "Ladrillo de revestimiento delgado con textura artesanal para vestir muros interiores con muy poco espesor. Disponible en Natural, Bianco, Capuccino y Cocoa para componer desde ambientes cálidos hasta contrastes contemporáneos.",
    applications: [
